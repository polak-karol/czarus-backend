...
class ClientAuthorization(BaseResource):
    ...
    def post(cls):
        ...
        if "token" not in client_authorization_json or client_authorization_json[
            "token"
        ] != os.getenv("SUPER_TOKEN"):
            error_response = {
        ...
        access_token = create_access_token(
            identity=client_authorization_json["token"], fresh=True, expires_delta=False
        )
