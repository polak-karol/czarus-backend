...
class DiscordLogin(BaseResource):
    ...
    def post(cls):
        ...
        response_oauth = requests.post('https://discord.com/api/oauth2/token', data=data, headers=headers)
        ...
        response_user = requests.get('https://discordapp.com/api/users/@me', headers={'Authorization': f"Bearer {tokens['access_token']}"})
